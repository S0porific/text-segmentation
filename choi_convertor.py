...
def convert_choi_to_bySegLength(path):
    ...
    for folder in folders:
        ...
        seg_folders = [o for o in os.listdir(full_folder_path) if
                       os.path.isdir(os.path.join(full_folder_path, o))]
        for seg_folder in seg_folders:
            ...
            convertedPath = os.path.sep.join(
                convertedPathList[:-2] + [convertedPathList[-1]] + [
                    convertedPathList[-2]])
